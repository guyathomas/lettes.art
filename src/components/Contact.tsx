export function Contact() {
  return (
    ...
    >
      <div className="hairline-left mb-8" />
      ...
      <a
        ...
        className="inline-flex items-center gap-2 min-h-11 text-accent hover:text-accent/80 active:scale-(--press-scale) transition-all duration-200 font-medium"
      >
        lette@example.com
